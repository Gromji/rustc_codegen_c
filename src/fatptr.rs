use crate::{definition::CVarDef, structure::{CComposite, CStructDef}, ty::CType};
...
pub fn new_fat_ptr() -> CComposite {
    let fat_ptr_composite = CComposite::Struct(CStructDef{
        ...
        fields: vec![
            CVarDef::new(0, FAT_PTR_DATA_FIELD.to_string(), CType::Pointer(Box::new(CType::Void))),
            CVarDef::new(1, FAT_PTR_META_FIELD.to_string(), CType::Pointer(Box::new(CType::Void))),
        ],
    });
